...
namespace org.apache.hadoop.hive.ql.io.orc.external
{
    ...
    using org.apache.hadoop.hive.ql.io.orc.encoded;
    ...
    public interface DataCache
    {
        ...
        DiskRangeList getFileData(long fileId, DiskRangeList range, long baseOffset,
            DiskRangeListFactory factory, StrongBox<bool> gotAllData);
    ...
    class Allocator
    {
        ...
        internal MemoryBuffer createUnallocated()
        {
            throw new System.NotImplementedException();
        }

        internal int getMaxAllocation()
        {
            throw new System.NotImplementedException();
        }
    }
