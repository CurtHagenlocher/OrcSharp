...
namespace org.apache.hadoop.hive.ql.io.orc
{
    ...
    public interface Reader
    {
         ...
         * @return raw data size of columns
         */
        long getRawDataSizeFromColIndices(List<int> colIds);
         ...
         */
        bool hasMetadataValue(string key);
         ...
         */
        IList<StripeInformation> getStripes();
         ...
         * @
         */
        RecordReader rowsOptions(RecordReaderOptions options);
         ...
         * @
         */
        RecordReader rows(bool[] include);
         ...
         */
        RecordReader rows(long offset, long length,
                          bool[] include, SearchArgument sarg,
         ...
         */
        IList<OrcProto.StripeStatistics> getOrcProtoStripeStatistics();
         ...
         */
        IList<OrcProto.ColumnStatistics> getOrcProtoFileStatistics();
         ...
         */
        DataReader createDefaultDataReader(bool useZeroCopy);
     ...
     */
    public class RecordReaderOptions
    {
        ...
        private bool? _skipCorruptRecords = null;
         ...
         * @return this
         */
        public RecordReaderOptions include(bool[] include)
        {
         ...
         * @return this
         */
        public RecordReaderOptions range(long offset, long length)
        {
            this.offset = offset;
            this.length = length;
            return this;
         ...
         * @return this
         */
        public RecordReaderOptions searchArgument(SearchArgument sarg, string[] columnNames)
        {
            this.sarg = sarg;
         ...
         * @return this
         */
        public RecordReaderOptions useZeroCopy(bool value)
        {
            this._useZeroCopy = value;
            return this;
        }
         ...
         * @return this
         */
        public RecordReaderOptions skipCorruptRecords(bool value)
        {
            this._skipCorruptRecords = value;
            return this;
        }
        ...
        {
            RecordReaderOptions result = new RecordReaderOptions();
            ...
            result._skipCorruptRecords = _skipCorruptRecords;
            return result;
        }
